...
{
    document.getElementById("dayValue").innerHTML = '17';
...
//    document.getElementById("red-calendarWrapper").innerHTML = '<div id="red-calendarWrapper">';

//    document.getElementById("red-calendarWrapper").innerHTML += '<div id="tableHeader">';

//    document.getElementById("red-calendarWrapper").innerHTML += '<div class="day">';

//    document.getElementById("red-calendarWrapper").innerHTML += '<a href="">Â«</a><span>14</span><a href="#">Â»</a>';

//    document.getElementById("red-calendarWrapper").innerHTML += '</div>';
           
//    document.getElementById("red-calendarWrapper").innerHTML += '<div class="month">';
               
//    document.getElementById("red-calendarWrapper").innerHTML += 'FebuaryTest';
